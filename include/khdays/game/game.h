...
// each frame updates the task queue, then updates and renders the current
// scene, applying scene transitions. VBlank sync, rendering, and input come
// from the platform layer; this owns only the flow.
